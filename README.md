...
本仓库本身不含模型代码，是 **ACE-Step 的包装层 + 11 Tab 统一控制台**(历史索引、自动后处理、LoRA 数据/管理、批量生成、A/B 对比、Prompt 工作室、Song→DAW 导出、封面&字幕、续写&翻唱、一键 MIDI)。
...
| `start-lab.bat` | 7861 | **统一控制台**(11 Tab,见下方表格) |
...
# 统一控制台 UI(http://localhost:7861, 11 Tab)
